...
function Session({ session }) {
    ...
    return (
        <div
            ...
            <div>
                cost: {session.session.cost} lei
            </div>
            <div className='flex justify-end'>
                <button type="button" onClick={handleClick} className=" text-white bg-purple-500 hover:bg-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Join</button>
            </div>
        </div>
    );
}
