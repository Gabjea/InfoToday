...
export default function Sidebar({ socket }) {
  ...
  const [Menus, setMenus] = React.useState([
    ...
    {
      title: "Cont",
      src: CookieManager.getCookie("jwt") ? faUserCheck : faUser,
      route: "/account",
    },
